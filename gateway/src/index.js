    ...
    http
      .request(
        ...
        (response) => {
              ...
              .request(
                ...
                (response) => {
                  ...
                  response.on('end', () => {
                    ...
                    res.render('video-list', { videos: JSON.parse(data).videos, ads: JSON.parse(ads) })
                  })
          ...
          response.on('error', (err) => {
            console.error('Failed to get advertise.')
            console.error(err || `Status code: ${response.statusCode}`)
            res.sendStatus(500)
          })
        }
      ...
      .request(
        ...
        (response) => {
          ...
          response.on('end', (chunk) => {
            res.render('upload-video', { ads: JSON.parse(ads) })
          })
              ...
              .request(
                ...
                (response) => {
                  ...
                  response.on('end', () => {
                    ...
                    res.render('history', { videos: JSON.parse(data).videos, ads: JSON.parse(ads) })
                  })
